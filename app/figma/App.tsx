...
const App = () => {
  ...
  useEffect(() => {
    ...
    /* listen to the key down event on the window which is fired when the
     ...
     We're using this to perform some actions like delete, copy, paste, etc when 
     the user presses the respective keys on the keyboard. */
    ...
    return () => {
      ...
      const fabricRefCurrent = fabricRef.current;

      window.removeEventListener("keydown", (e) =>
        handleKeyDown({
          e,
          canvas: fabricRefCurrent,
          undo,
          redo,
          syncShapeInStorage,
          deleteShapeFromStorage,
